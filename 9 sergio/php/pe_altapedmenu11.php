...
<br><br>
    ...
    <label> Segundos: <label><br>
        <select name="Id_plato">
            <?php
                $desplegableProductos= desplegableProductos2($conexion); //Se despliegan los productos QUE TENGAN STOCK.
        ...
        <br><br>
            <input type="submit" value="Añadir segundo"  name="agregar">
       ...
       <?php
        if($_POST){
            ...
            //Si se pulsa agregar hay que comprobar que hay stock suficiente según el número de unidades que quiera el cliente de cada producto.
              ...
              header("location: ./pe_altapedmenu12.php");
            }// fin if agregar
