...
<html>
  ...
  <body>
    ...
    <div class="menulateral">
      ...
      <a href="pe_consprodstock.php">Consultar Stock Producto</a>
     ...
     <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
       <div class="opciones"><center>    <?php echo "Has iniciado sesion como: <b>".nombreCliente($_SESSION['Nombre'],$conn)."</b>";?></center></div>
