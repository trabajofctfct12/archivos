...
if($_POST){
    ...
    if (isset($_POST['crear'])) {
      $sqlConsulta = "INSERT INTO Usuarios (`Tipo_usuario`,`Nombre`, `Apellidos`,`Contraseña`, `Ciudad`, `Pais`, `Codigo_postal`, `Telefono`, `Email`, `Saldo`) VALUES ('Cliente', '$Nombre', '$Apellidos','$Contraseña', '$Ciudad', '$Pais', '$Codigopostal', '$Telefono', '$Email', '$Saldo')";
    	 try {
