...
<br><br>
    ...
    <label> Postres: <label><br>
        <select name="Id_plato">
            <?php
                $desplegableProductos= desplegableProductos3($conexion); //Se despliegan los productos QUE TENGAN STOCK.
        ...
        <br><br>
            <input type="submit" value="Añadir postre"  name="agregar">
       ...
       <?php
        if($_POST){
            ...
            //Si se pulsa agregar hay que comprobar que hay stock suficiente según el número de unidades que quiera el cliente de cada producto.
                ...
                header("location: ./pe_altapedmenu13.php");
