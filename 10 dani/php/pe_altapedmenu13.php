...
<br><br>
    ...
    <label> Bebidas: <label><br>
        <select name="Id_plato">
            <?php
                $desplegableProductos= desplegableProductos4($conexion); //Se despliegan los productos QUE TENGAN STOCK.
        ...
        <br><br>
            <input type="submit" value="Añadir bebida"  name="agregar">
       ...
       <?php
        if($_POST){
            ...
            //Si se pulsa agregar hay que comprobar que hay stock suficiente según el número de unidades que quiera el cliente de cada producto.
                ...
                header("location: ./pe_altapedmenufinal.php");
